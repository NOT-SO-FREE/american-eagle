...
const HeroSection = () => {
  return (
    <div className="max-w-lg mx-auto text-center">
      ...
      <h1 className="text-lg md:text-xl font-bold text-[#1b2f4a] mb-1.5 px-2 relative -mt-4">
      ...
      <p className="text-xs md:text-sm text-[#2b4567] mb-2 font-medium px-2 relative">
